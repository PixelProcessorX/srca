...
-- Dump completed on 2016-04-18 21:22:55
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
CREATE TABLE `cats_event` (
  ...
  KEY `id_fit` (`id_fit`),
  CONSTRAINT `id_fitness2` FOREIGN KEY (`id_fit`) REFERENCES `cats_fit` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `cats_impr` (
  ...
  CONSTRAINT `id_fitness` FOREIGN KEY (`id_fit`) REFERENCES `cats_fit` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `events_` (
  ...
  `WhenDays` varchar(256) CHARACTER SET utf8 DEFAULT 'Not Defined',
  ...
  CONSTRAINT `W` FOREIGN KEY (`id_cat`) REFERENCES `cats_event` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `Z` FOREIGN KEY (`id_instructor`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
