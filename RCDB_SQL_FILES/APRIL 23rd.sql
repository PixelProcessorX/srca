...
-- Dump completed on 2016-04-23 21:58:06
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The users in the database. Contains a minimum of information required to authenticate.';
/*!40101 SET character_set_client = @saved_cs_client */;
