...
-- Dump completed on 2016-02-18 23:45:38
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
--
-- Table structure for table `authoritytemplates`
--

DROP TABLE IF EXISTS `authoritytemplates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `authoritytemplates` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Holds the data regarding autority roles for users in the Rec Center database.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `authoritytemplates`
--

LOCK TABLES `authoritytemplates` WRITE;
/*!40000 ALTER TABLE `authoritytemplates` DISABLE KEYS */;
/*!40000 ALTER TABLE `authoritytemplates` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `bodyimprovements`
--

DROP TABLE IF EXISTS `bodyimprovements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bodyimprovements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(45) COLLATE utf8_unicode_ci DEFAULT 'Created_BodyImprovementItem',
  `Decsription` varchar(256) COLLATE utf8_unicode_ci DEFAULT 'No Description Provided',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
--
-- Dumping data for table `bodyimprovements`
--

LOCK TABLES `bodyimprovements` WRITE;
/*!40000 ALTER TABLE `bodyimprovements` DISABLE KEYS */;
/*!40000 ALTER TABLE `bodyimprovements` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `eventcategories` (
  ...
  `FitnessType` int(11) DEFAULT NULL,
  `Tags` varchar(256) COLLATE utf8_unicode_ci DEFAULT 'EMPTY|NULL',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Types of Rec Center events.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `events` (
  ...
  `WhenBeg` date DEFAULT NULL,
  `WhenEnd` date DEFAULT NULL,
...
DROP TABLE IF EXISTS `fitnesscategories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fitnesscategories` (
  ...
  `BodyImprovementTags` varchar(256) COLLATE utf8_unicode_ci DEFAULT 'EMPTY|NULL',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `fitnesscategories` WRITE;
/*!40000 ALTER TABLE `fitnesscategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `fitnesscategories` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `AuthorityLevel` int(11) NOT NULL DEFAULT '0',
  `IsCustomer` bit(1) NOT NULL DEFAULT b'0',
  `PassHash` varbinary(4096) DEFAULT NULL,
  `AuthToken` varbinary(4096) DEFAULT NULL,
  `CardID` varchar(45) COLLATE utf8_unicode_ci DEFAULT 'EMPTY',
  `Name` varchar(45) COLLATE utf8_unicode_ci DEFAULT 'Anonymous User',
...
-- Dump completed on 2016-02-18 23:45:39
