...
-- Dump completed on 2016-03-25 10:04:19
CREATE DATABASE  IF NOT EXISTS `rcdb` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `rcdb`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
...
CREATE TABLE `events_` (
  ...
  `WhenDaysHours` varchar(256) CHARACTER SET utf8 DEFAULT 'Not Defined',
  ...
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `W_idx` (`id_cat`),
  KEY `Z_idx` (`id_instructor`),
  CONSTRAINT `W` FOREIGN KEY (`id_cat`) REFERENCES `cats_event` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Z` FOREIGN KEY (`id_instructor`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `events_` VALUES (1,1,NULL,'Event #0','Junk data...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',123),(2,5,NULL,'Event #1','Junk data dfghbdrst...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',234),(3,3,NULL,'Event #2','adryhsxtfhbta...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',345),(4,1,NULL,'Event #3','Juszdrtbyzdthbfghfgha...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',456),(5,2,NULL,'Event #4','Aced Acrobatics...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',777),(6,6,NULL,'Event #5','74785675667...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',369),(7,1,NULL,'Event #6','Testingonetwothree...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',1111),(8,4,NULL,'Event #7','BigExcercise...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',4444),(9,1,NULL,'Event #8','Pascal\'s Plethora...','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',12421),(10,3,NULL,'Event #9','Failed Doomsday','Not Defined','1900-01-01 00:00:00','1900-01-01 00:00:00',2012);
...
INSERT INTO `userevents` VALUES (1,5,8,'','\0','Quartz Task #0','\0','1900-01-01 00:00:00'),(2,5,9,'','\0','Quartz Task #1','\0','1900-01-01 00:00:00'),(3,5,5,'','\0','Quartz Task #2','\0','1900-01-01 00:00:00'),(4,3,7,'','\0','myEventNofification','\0','1900-01-01 00:00:00'),(5,2,2,'','\0','Yoga Class','\0','1900-01-01 00:00:00'),(6,1,1,'','\0','DUMBELLS','\0','1900-01-01 00:00:00');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The users in the database. Contains a minimum of information required to authenticate.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'\0','\0',NULL,NULL,NULL,'Jhon Doe','54dc9647601761f0791d1217ce3483e9'),(2,'\0','\0',NULL,NULL,NULL,'Jane Doe','9320789ed7fbb2fcef85804ece29abb0'),(3,'\0','\0',NULL,NULL,NULL,'Dr. Deqan Delinquist','d2203000ac404b8878a29059e53621b6'),(4,'\0','\0',NULL,NULL,NULL,'Fake Oracle America Rep.','cfd70644fa67581a06daca5dba5437c7'),(5,'\0','\0',NULL,NULL,NULL,'Quartztet Qulaervich','d9d8611e8dec8e4b9e00751140c01ab9');
...
SELECT DISTINCT cats_event.* FROM cats_event, cats_fit, cats_impr WHERE 
	...
	((p_name_contains IS NULL) OR (cats_event.`Name`        LIKE CONCAT('%',p_name_contains COLLATE utf8_unicode_ci,'%'))) AND
	((p_desc_contains IS NULL) OR (cats_event.`Description` LIKE CONCAT('%',p_desc_contains COLLATE utf8_unicode_ci,'%'))) AND
	((p_tags_contains IS NULL) OR (cats_event.`Tags`        LIKE CONCAT('%',p_tags_contains COLLATE utf8_unicode_ci,'%')));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2016-03-25 10:04:20
